export class GameEngine {
  private ball = { x: 400, y: 300, dx: 4, dy: 4 };
  private paddles = { left: 150, right: 150 };
  private readonly paddleSpeed = 5;

  updatePaddle(player: "left" | "right", direction: "up" | "down") {
      if (direction === "up") this.paddles[player] -= this.paddleSpeed;
      else this.paddles[player] += this.paddleSpeed;
  }
